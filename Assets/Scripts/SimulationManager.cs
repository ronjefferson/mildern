...
public class SimulationManager : MonoBehaviour
{
    ...
    void Initialize()
    {
        ...
        List<Building> homes = BuildingManager.Instance.GetResidential(); List<Building> works = BuildingManager.Instance.GetWorkplace(); List<Building> commercials = BuildingManager.Instance.GetCommercial(); List<Building> hospitals = BuildingManager.Instance.GetHealthcare(); if (hospitals.Count == 0) hospitals = commercials; if (homes.Count == 0) return;
